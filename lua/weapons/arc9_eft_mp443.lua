...
SWEP.ViewModel = "models/weapons/arc9/darsu_eft/c_mp443_2.mdl"
...
local rst_def = {
    ...
    { s =  path .. "grach_mag_out.ogg", t = 0.3 },
    { s = pouchin, t = 0.7 },
    { s = pouchout, t = 1.0 },
    -- { s = randspin, t = 1.1 },
    { s =  path .. "grach_mag_in.ogg", t = 1.5 },
    { s = randspin, t = 1.8 },
}
local rst_def2 = {
    { s = randspin, t = 0.1 },
    ...
    -- { s = randspin, t = 1.1 },
    { s =  path .. "grach_mag_in.ogg", t = 1.5+0.3 },
...
local rst_tac = {
    ...
    { s =  path .. "grach_mag_out.ogg", t = 0.2 - 4/27 },
    { s =  randspin, t = 0.53 - 4/27 },
    { s = pouchout, t = 0.7 - 4/27 },
    { s =  path .. "grach_mag_in.ogg", t = 1.3 - 4/27 },
...
local rst_tac2 = {
    ...
    { s =  path .. "grach_mag_in.ogg", t = 1.3 - 4/27+0.25 },
...
local rst_empty = {
    ...
    { s =  path .. "grach_mag_out.ogg", t = 0.2 },
    { s =  randspin, t = 0.53 },
    { s = pouchout, t = 0.7 },
    { s =  path .. "grach_mag_in.ogg", t = 1.3 },
    { s = randspin, t = 1.7 },  
    { s =  path .. "grach_catch_slider.ogg", t = 2.1 },
    { s = randspin, t = 2.95 },
    {hide = 0, t = 0},
    {hide = 1, t = 0.4},
    {hide = 0, t = 1.0}
...
local rst_empty2 = {
    ...
    { s =  path .. "grach_mag_in.ogg", t = 1.3+0.25 },
    { s = randspin, t = 1.7+0.25 },  
    { s =  path .. "grach_catch_slider.ogg", t = 2.1+0.25 },
...
local rst_magcheck_empty = {
    ...
    { s =  path .. "grach_mag_out.ogg", t = 0.2 },
    { s =  path .. "grach_mag_in.ogg", t = 1.35 },
    { s = randspin, t = 1.4 },
}
...
SWEP.Animations = {
    ...
    ["ready"] = {
        ...
        EventTable = {
            ...
            { s = path .. "grach_slider_in.ogg", t = 0.32 },
            { s = path .. "grach_slider_out.ogg", t = 0.53 },
        },
    },
    ["ready2"] = {
        Source = {"ready2"},
    ...
    ["fire_empty"] = {
        Source = "fire_last",
        EventTable = {
            { s = path .. "grach_catch_slider.ogg", t = 0, v = 0.5 },
        }
    },
    ["dryfire"] = {
        Source = "fire_dry",
    ...
    ["jam0"] = {
        ...
        EventTable = {
            ...
            { s =  path .. "grach_slider_out.ogg", t = 1.7 },
            { s = "arc9_eft_shared/weap_round_out.ogg", t = 1.77 },
            { s =  path .. "grach_slider_in.ogg", t = 1.84 },
            { s = randspin, t = 2 },
        },
        EjectAt = 1.79
    },        
    ...
    ["jam1"] = {
        ...
        EventTable = {
            ...
            { s =  path .. "grach_slider_out.ogg", t = 2.48 },
            { s = randspin, t = 2.61 },
    ...
    ["jam3"] = {
        ...
        EventTable = {
            ...
            { s = randspin, t = 2.9 },
            { s =  path .. "grach_slider_out.ogg", t = 3.86 },
            { s = "arc9_eft_shared/weap_round_out.ogg", t = 3.95 },
            { s =  path .. "grach_slider_in.ogg", t = 4.06 },
            { s = randspin, t = 4.13 },
        },
        EjectAt = 3.95
    },      
    ...
    ["jam4"] = {
        ...
        EventTable = {
            ...
            { s =  path .. "grach_slider_out.ogg", t = 2.63 },
            { s = "arc9_eft_shared/weap_round_out.ogg", t = 2.71 },
            { s =  path .. "grach_slider_in.ogg", t = 2.8 },
            { s = randspin, t = 2.9 },
        },
        EjectAt = 2.71
    },
    ...
    ["inspect0"] = {
        ...
        EventTable = {
            { s = randspin, t = 0.1 },
            { s = path .. "grach_slider_in.ogg", t = 0.27 },
            { s = path .. "grach_slider_out.ogg", t = 0.9 },
            { s = randspin, t = 1.0 },
        }
    },
    ["inspect_empty0"] = {
