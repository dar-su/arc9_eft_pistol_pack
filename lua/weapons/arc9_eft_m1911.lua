...
SWEP.PrintName = ARC9:GetPhrase("eft_weapon_m1911a1")
SWEP.Description = ARC9:GetPhrase("eft_weapon_m1911a1_desc")
...
SWEP.CustomizePos = Vector(22, 40, 3.8)
...
if GetConVar("arc9_eft_nontpik_mode"):GetBool() then -- pistols
    ...
    SWEP.WorldModelOffset = { -- some bitches turn on nontpik mode while keeping tpik on
        ...
        TPIKHolsterOffset = Vector(13, -3, 0),
...
SWEP.MalfunctionMeanShotsToFail = 1000 * 1.5
